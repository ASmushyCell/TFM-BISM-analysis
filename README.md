...
> [!WARNING]
>  If running `pre_process_beforePIV.ijm` takes a long time, it may be because your images are encoded in 16-bit. Consider converting them to 8-bit before processing with the pipeline to significantly reduce computation time.  
